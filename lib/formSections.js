export const formSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "assistantClerkName", label: "Assistant Clerk Name", type: "text" },
      { id: "assistantClerkTitle", label: "Assistant Clerk Title", type: "text" }
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "noteText", label: "Bottom Note Text", type: "text" },
      { id: "noteInitials", label: "Bottom Note Initials", type: "text" }
    ]
  }
];
